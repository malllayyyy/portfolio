...
export const ROUTES: RouteEntry[] = [
  ...
  { path: '/project/gamezone',            depth:  -52, title: t('GameZone'),                   description: 'Gaming-cafe POS and Android app, tuned for Windows 7 and a spinning disk.', openPanel: 'gamezone' },
